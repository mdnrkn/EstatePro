    ...
    <div class="container">
        <div class="card" style="max-width: 600px; margin: 0 auto;">
            <div style="display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #eee; padding-bottom: 15px; margin-bottom: 20px;">
                <h2 style="margin: 0;">Edit Staff Profile</h2>
            ...
            <form action="index.php?action=update_profile_submit" method="POST" enctype="multipart/form-data">
                ...
                <div style="text-align: center; margin-bottom: 20px;">
                    ...
                    ?>
                    <img src="<?php echo $img_src; ?>" style="width: 120px; height: 120px; border-radius: 50%; object-fit: cover; border: 3px solid #1abc9c;">
                    <br>
                    <label style="cursor: pointer; color: #1abc9c; font-weight: bold; margin-top: 10px; display: inline-block;">
                        Change Photo
